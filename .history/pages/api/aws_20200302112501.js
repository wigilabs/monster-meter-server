...
const handler = (req, res) => {
  ...
  superagent
    ...
    .end((err, response) => {
      ...
      let numCpu = eventsObj[0];
      let memTotalBytes = eventsObj[1];
      let maxCpuPercent = eventsObj[2];
      let maxMemoryPercent = eventsObj[3];
      let instanceType = eventsObj[4];
      let craftObj = [
        {
          numCpu: numCpu,
